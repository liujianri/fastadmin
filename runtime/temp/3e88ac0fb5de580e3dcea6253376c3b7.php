...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea type="text" name="row[remark]" data-rule required class="form-control"  rows="10">
            </textarea>
        </div>
    </div>
